  ...
  return (
    <div className="p-4 pb-24 max-w-lg mx-auto">
      <div className="mb-6 bg-gradient-to-br from-indigo-900 to-indigo-700 p-6 rounded-[2rem] text-white shadow-md relative overflow-hidden">
        ...
        <h1 className="text-2xl font-black mb-2">Ask an Expert</h1>
        <p className="text-sm text-indigo-200 font-medium leading-relaxed">
          Get direct advice from verified agronomists and local extension officers about pests, fertilizers, or farm management.
        </p>
      </div>

      <div className="bg-white rounded-[2rem] shadow-sm border border-stone-200 p-5 mb-6">
         <h3 className="font-bold text-stone-800 flex items-center gap-2 mb-4"><Icons.MessageCircle size={18} className="text-indigo-500" /> Submit your query</h3>
         ...
         <div className="space-y-4">
           ...
           <button className="w-full bg-indigo-600 text-white font-bold p-4 rounded-xl shadow-sm hover:bg-indigo-700 transition flex items-center justify-center gap-2">
             <Icons.Send size={18} /> Send to Expert
           </button>
         </div>
      </div>

      <div className="space-y-3">
         <h3 className="font-bold text-stone-800 text-sm mb-2">Past Consultations</h3>
         <div className="p-4 border border-stone-200 rounded-2xl bg-stone-50 text-center">
            ...
            <div className="text-sm font-bold text-stone-400">No past queries</div>
         </div>
      </div>
    </div>
  );
